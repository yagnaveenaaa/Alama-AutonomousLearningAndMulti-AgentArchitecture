...
class BffSettings(BaseServiceSettings):
    ...
    enable_vertical_slice: bool = Field(default=False)
    fixture_dir: str | None = Field(default=None)
    ...
    # Local slice identity defaults (web sends these headers)
    slice_subject_id: str = Field(default="01900000-0000-7000-8000-000000000010")
    slice_tenant_id: str = Field(default="01900000-0000-7000-8000-000000000011")
