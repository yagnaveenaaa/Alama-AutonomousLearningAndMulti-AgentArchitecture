...
def create_app(settings: IdentitySettings | None = None) -> FastAPI:
    ...
    app = FastAPI(
        title="Alama Identity Service",
        version="0.1.0",
        description="Tenants, subjects, role bindings, and API keys (LLD §2.3 / §5.2).",
        lifespan=lifespan,
        docs_url="/docs",
        redoc_url="/redoc",
