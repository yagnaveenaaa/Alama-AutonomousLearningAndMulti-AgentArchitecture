...
from repository_service.config import RepositorySettings
from repository_service.container import build_container


def create_app(settings: RepositorySettings | None = None) -> FastAPI:
    ...
    app = FastAPI(
        ...
        version="0.1.0",
        description="SCM installations, repository connections, webhooks, snapshots (LLD §2.4).",
        lifespan=lifespan,
        docs_url="/docs",
